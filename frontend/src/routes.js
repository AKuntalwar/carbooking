...
const Advertises = React.lazy(() => import('./components/Advertises/Advertises'))

const AddCarsData = React.lazy(() => import('./components/ManageCars/AddCarsData'))
const EditCars = React.lazy(() => import('./components/ManageCars/EditCars'))
...
const routes = [
  ...
  { path: '/advertises', name: 'Advertises', element: Advertises },
